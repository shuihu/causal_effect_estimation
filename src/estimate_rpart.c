...
static void
estimate_rpart0(const int *dimx, int nnode, int nsplit, const int *dimc,
...
SEXP
estimate_rpart(SEXP dimx, SEXP nnode, SEXP nsplit, SEXP dimc,
           ...
           SEXP csplit2, SEXP usesur, SEXP xdata2, SEXP xmiss2)
{
    ...
    estimate_rpart0(INTEGER(dimx), asInteger(nnode), asInteger(nsplit),
